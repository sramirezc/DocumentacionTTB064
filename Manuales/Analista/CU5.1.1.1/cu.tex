\subsection{Registrar Trayectoria}
...
\begin{itemize}
 \item Sección \textbf{Pasos de la Trayectoria}
  ...
  \end{enumerate}
  \item \cdtButton{Aceptar}: Mediante este botón puede registrar la Trayectoria.
  \item \cdtButton{Cancelar}: Mediante este botón puede cancelar el registro de la Trayectoria.
\end{itemize}
	
	
\subsubsection{Procedimiento}
\begin{enumerate}
	\item Oprima el botón \cdtButton{Registrar} de la pantalla \cdtFigureRef{fig:gestionarTrayectorias}{Gestionar Trayectorias}, el sistema mostrará la pantalla \cdtFigureRef{fig:registrarTrayectoria}{Registrar Trayectoria}. 

	%--------------------------------------------------------------------------------------------------------
	      \IUfig[.9]{CU5.1.1.1/images/registrarTrayectoria}{fig:registrarTrayectoria}{Registrar Trayectoria}
	%--------------------------------------------------------------------------------------------------------
	
	\item Ingrese la \textbf{Información general del Trayectoria}.
	
	\item Oprima el botón \cdtButton{Registrar} de la sección \textbf{Pasos de la Trayectoria} para registrar un Paso. El sistema mostrará la pantalla \cdtFigureRef{fig:registrarPaso}{Registrar Paso}. \label{cu5.1.1.1.1:paso:registrarPaso}

	%--------------------------------------------------------------------------------------------------------
	      \IUfig[.9]{CU5.1.1.1/images/registrarPaso}{fig:registrarPaso}{Registrar Paso}
	%--------------------------------------------------------------------------------------------------------
	...
	\item Oprima el botón \cdtButton{Aceptar} de la pantalla emergente. El sistema cerrará la pantalla emergente y agregará el Paso a la tabla de la sección \textbf{Pasos de la Trayectoria}. Para registrar más Pasos regrese al paso \ref{cu5.1.1.1.1:paso:registrarPaso}.
	
	\item Oprima el botón \btnEditar de la sección \textbf{Pasos de la Trayectoria} para modificar un Paso. El sistema mostrará la pantalla \cdtFigureRef{fig:modificarPaso}{Modificar Paso}. \label{cu5.1.1.1.1:paso:modificarPaso}
	...
	\item Oprima el botón \cdtButton{Aceptar} de la pantalla emergente. El sistema cerrará la pantalla emergente y modificará el Paso en la tabla de la sección \textbf{Pasos de la Trayectoria}. Para modificar más Pasos regrese al paso \ref{cu5.1.1.1.1:paso:modificarPaso}.
