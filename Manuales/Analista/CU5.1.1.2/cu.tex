...
\begin{enumerate}
	\item Oprima el botón \btnEditar de la Trayectoria que desea modificar en la pantalla \cdtFigureRef{fig:gestionarTrayectorias}{Gestionar Trayectorias}, el sistema mostrará la pantalla \cdtFigureRef{fig:modificarTrayectoria}{Modificar Trayectoria}. 
