...
\begin{itemize}
  ...
  \end{enumerate}
 \item \cdtButton{Aceptar}: Mediante este botón puede modificar la Entidad.
 \item \cdtButton{Cancelar}: Mediante este botón puede cancelar la modificación de la Entidad.
\end{itemize}
	
	
\subsubsection{Procedimiento}
\begin{enumerate}
	\item Oprima el botón \btnEditar de la Entidad que desea modificar en la pantalla \cdtFigureRef{fig:gestionarEntidades}{Gestionar Entidades}, el sistema mostrará la pantalla \cdtFigureRef{fig:modificarEntidad}{Modificar Entidad}. 

	%--------------------------------------------------------------------------------------------------------
	      \IUfig[.9]{CU11.2/images/modificarEntidad}{fig:modificarEntidad}{Modificar Entidad}
	%--------------------------------------------------------------------------------------------------------
	
	\item Modifique la \textbf{Información general de la Entidad}.
	
	\item Oprima el botón \cdtButton{Registrar} de la sección \textbf{Atributos de la Entidad}, el sistema mostrará la pantalla emergente \cdtFigureRef{fig:registrarAtributo}{Registrar Atributo}. \label{cu11.2:paso:registrarAtributo} 
	...
	\item Oprima el botón \cdtButton{Aceptar}, el sistema mostrará la pantalla \cdtFigureRef{fig:modificarEntidad}{Modificar Entidad} con el Atributo en la sección \textbf{Atributos de la Entidad}.
