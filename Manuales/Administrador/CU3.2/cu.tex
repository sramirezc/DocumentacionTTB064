...
\begin{enumerate}
	\item Oprima el botón \btnEditar del Módulo que desea modificar en la pantalla \cdtFigureRef{fig:gestionarModulos}{Gestionar Módulos}, el sistema mostrará la pantalla \cdtFigureRef{fig:modificarModulo}{Modificar Módulo}. 
