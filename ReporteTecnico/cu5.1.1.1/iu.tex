...
\begin{description}
	...
	\item[ \cdtIdRef{MSG7}{Registro repetido}:] Se muestra en la pantalla \cdtIdRef{IU 5.1.1.1}{Registrar trayectoria} cuando se hayan registrado dos casos de uso con el mismo nombre.
