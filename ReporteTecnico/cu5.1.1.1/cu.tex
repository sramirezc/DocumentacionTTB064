...
% 			\UCli \cdtRef{Paso:Redaccion}{Redacción del paso}: \ioEscribir.
			\UCli \cdtRef{}{Principal o alternativa}: \ioSeleccionar.
			\UCli \cdtRef{}{Nombre de la trayectoria}: \ioEscribir.
		\end{UClist}
	}
	\UCitem{Salidas}{
		\begin{UClist}
			\UCli Pasos de la trayectoria.
		\end{UClist}
	}
	...
	\UCitem{Postcondiciones}{
		\begin{UClist}
			\UCli Los elementos utilizados en los pasos y que no estén descritos en la sección ``Descripción del Caso de uso'' de la pantalla 
			      \cdtIdRef{CU 5.1}{Registrar caso de uso} se agregarán en el campo correspondiente.
		\end{UClist}
	}
