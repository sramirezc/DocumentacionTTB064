\begin{UseCase}{CU 13}{Iniciar sesión}
	...
	\UCitem{Entradas}{
		\begin{UClist} 
			\UCli \cdtRef{Colaborador:CorreoElectronico}{Correo electrónicod}: \ioEscribir
...
\end{UseCase}
 ...
 \begin{UCtrayectoriaA}{C}{Existe un error en los datos.}
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG31}{Correo electrónico y/o contraseña incorrectos}, para indicar que los datos ingresados son incorrcetos.
    \UCpaso[] Continúa con el paso \ref{cu13:ingresaDatos} de la trayectoria principal.
 \end{UCtrayectoriaA}