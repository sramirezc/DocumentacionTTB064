\begin{UseCase}{CU 1.1}{Registrar proyecto}
	...
	\UCitem{Precondiciones}{
		\begin{UClist}
			...
			\UCli Que existan estados para iniciar un proyecto.
		\end{UClist}
	}
	...
	\UCitem{Errores}{
		\begin{UClist}
			...
			\UCli \cdtIdRef{MSG13}{Ha ocurrido un error}: Se muestra en la pantalla \cdtIdRef{IU 1}{Gestionar proyectos} cuando no exista información de los estados con los que puede iniciar un proyecto.
...
%-------------------------------------------------------%trayectoria Principal-----------------------------------------------
 \begin{UCtrayectoria}
    ...
    \UCpaso[\UCsist] Verifica que existan estados con los que puede iniciar un proyecto, con base en la regla de negocio \cdtIdRef{RN20}{Verificación de catálogos}. \refTray{A}
 ...
 \begin{UCtrayectoriaA}[Fin del caso de uso]{A}{No hay estados con los que puede iniciar un proyecto.}
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG13}{Ha ocurrido un error} en la la pantalla \cdtIdRef{IU 1}{Gestionar proyectos de Administrador}.
 \end{UCtrayectoriaA} 
 %----------------------------------------------------------%trayectoria B---------------------------------------------------- 
