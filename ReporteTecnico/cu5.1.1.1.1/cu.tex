\begin{UseCase}{CU 5.1.1.1.1}{Registrar paso}
	...
	\UCitem{Mensajes}{
		\begin{UClist}
			...
			para indicar que el registro del paso fue exitoso.
		\end{UClist}
	}
...
%-------------------------------------------------------%trayectoria Principal-----------------------------------------------
 ...
 \begin{UCtrayectoria}
	...
	\UCpaso[\UCactor] Ingresa la redacción del paso. \refTray{A} \refTray{B} \refTray{C} \refTray{D} \refTray{E} \refTray{F} \refTray{G} \refTray{H} \label{cu5.1.1.1.1:ingresaPaso}
	\UCpaso[\UCactor] Solicita registrar el paso oprimiendo el botón \cdtButton{Aceptar} de la pantalla \cdtIdRef{CU 5.1.1.1.1}{Registrar paso}. \refTray{I} 
	\UCpaso[\UCsist] Verifica que el actor haya ingresado todos los campos obligatorios con base en la regla de negocio \cdtIdRef{RN8}{Datos obligatorios}. \refTray{J}
	\UCpaso[\UCsist] Verifica que los datos requeridos sean proporcionados correctamente como se especifica en la regla de negocio \cdtIdRef{RN7}{Información correcta}. \refTray{K} 
