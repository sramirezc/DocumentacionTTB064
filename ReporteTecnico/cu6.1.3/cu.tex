...
%-------------------------------------------------------%trayectoria Principal-----------------------------------------------
 \begin{UCtrayectoria}
    \UCpaso[\UCactor] Solicita eliminar una acción oprimiendo el botón \btnEliminar del registro que desea eliminar de la pantalla \cdtIdRef{CU 6.1}{Registrar pantalla} o \cdtIdRef{CU 6.2}{Modificar pantalla}.
    ...
    \UCpaso[\UCsist] Muestra la pantalla \cdtIdRef{IU 6.1.3}{Eliminar acción}. 
    \UCpaso[\UCactor] Confirma la eliminación de la acción oprimiendo el botón \cdtButton{Aceptar}. \refTray{B}
 ...
 \begin{UCtrayectoriaA}[Fin del caso de uso]{C}{El actor desea cancelar la operación.}
    \UCpaso[\UCactor] Solicita cancelar la operación oprimiendo el botón \cdtButton{Cancelar} de la pantalla \cdtIdRef{IU 6.1.3}{Eliminar acción}.
    \UCpaso[\UCsist] Muestra la pantalla donde se solicitó la operación.
 \end{UCtrayectoriaA} 