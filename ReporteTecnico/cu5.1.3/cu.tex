\begin{UseCase}{CU 5.1.3}{Gestionar postcondiciones}
	...
	\UCitem{Salidas}{
		\begin{UClist}
			\UCli \cdtRef{Postcondicion}{Postcondición}: \ioTabla{la \cdtRef{Postcondicion:Redacción}{Redacción}}.
		\end{UClist}
	}
...
%-------------------------------------------------------%trayectoria Principal-----------------------------------------------
 \begin{UCtrayectoria}
    \UCpaso[\UCactor] Solicita gestionar las postcondiciones del caso de uso en la sección ``Postcondiciones'' de la pantalla \cdtIdRef{IU 5.1}{Registrar caso de uso} o \cdtIdRef{IU 5.2}{Modificar caso de uso}.
    \UCpaso[\UCsist] Verifica que la operación sea registrar caso de uso. \refTray{A}
    \UCpaso[\UCactor] Gestiona las postcondiciones a través de los botones: \cdtButton{Registrar} y \btnEliminar. \label{cu5.1.3:gestionaCU}
 \end{UCtrayectoria}
 
 \begin{UCtrayectoriaA}[Fin del caso de uso]{A}{La operación es una modificación.}
    \UCpaso[\UCsist] Busca información de las postcondiciones del caso de uso. \refTray{B}
 ...
 \begin{UCtrayectoriaA}[Fin del caso de uso]{B}{No existen registros de postcondiciones.}
