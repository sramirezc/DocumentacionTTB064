\begin{UseCase}{CU 5.1}{Registrar caso de uso}
	...
	\UCitem{Propósito}{
		Registrar la información de un caso de uso e indicar el módulo al que pertenece.
	}
	\UCitem{Entradas}{
		\begin{UClist} 
			...
			\UCli De la sección {\bf Descripción del caso de uso}:
				\begin{Citemize}
					...
					\item \cdtRef{Mensaje}{Mensajes}: \ioEscribirSeleccionar.
				\end{Citemize}
	...
	\UCitem{Mensajes}{	
		\begin{UClist}
			\UCli \cdtIdRef{MSG1}{Operación exitosa}: Se muestra en la pantalla \cdtIdRef{CU 5}{Gestionar casos de uso} para indicar que el registro fue exitoso.
			\UCli \cdtIdRef{MSG3}{Caso de uso terminado}: Se muestra en la pantalla \cdtIdRef{CU 5}{Gestionar casos de uso} para indicar que el 
	...
	\UCitem{Postcondiciones}{ 
		\begin{UClist}
			\UCli El estado del caso de uso cambiará a ``Terminado''.
...
\end{UseCase}
 ...
 \begin{UCtrayectoria}
    \UCpaso[\UCactor] Solicita registrar un caso de uso oprimiendo el botón \btnNuevo de la pantalla \cdtIdRef{CU 5}{Gestionar casos de uso}.
    ...
    \UCpaso[\UCactor] Ingresa los datos del caso de uso en la pantalla \cdtIdRef{IU 5.1}{Registrar caso de uso}. \label{cu5.1:ingresaDatos}
    ...
    \UCpaso[\UCactor] Oprime el botón \cdtButton{Aceptar} del mensaje de confirmación. \refTray{G}
    ...
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG3}{Caso de uso terminado} en la pantalla \cdtIdRef{CU 5}{Gestionar casos de uso} 
 ...
 \begin{UCtrayectoriaA}[Fin del caso de uso]{A}{El actor no desea terminar la edición.}
    ...
    \UCpaso[\UCsist] Actualiza la fecha de la última actualización y solicita las observaciones de la actualización.
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG1}{Operación exitosa} en la pantalla \cdtIdRef{CU 5}{Gestionar casos de uso} 
    para indicar al actor que el registro se ha realizado exitosamente.
 \end{UCtrayectoriaA}
 %----------------------------------------------------------%trayectoria B---------------------------------------------------- 
 \begin{UCtrayectoriaA}[Fin del caso de uso]{B}{El actor desea cancelar la operación.}
    ...
    \UCpaso[\UCsist] Muestra la pantalla \cdtIdRef{CU 5}{Gestionar casos de uso}.
 \end{UCtrayectoriaA}
  %----------------------------------------------------------%trayectoria C---------------------------------------------------- 
 ...
 \end{UCtrayectoriaA}
 %----------------------------------------------------------%trayectoria G---------------------------------------------------- 
 \begin{UCtrayectoriaA}{G}{El actor desea cancelar el envío de la información.}
...
\UCExtensionPoint{El actor requiere gestionar la trayectoria principal del caso de uso}
