\begin{UseCase}{CU 8.1}{Registrar reglas de negocio}
	{
	...
	\UCitem{Entradas}{
		\begin{UClist}
			\UCli \cdtRef{Elemento:Nombre}{Nombre}: \ioEscribir.
 			...
 			\begin{itemize}
 			 \item \cdtRef{ReglaDeNegocio:ValorDelParametroEnReglaDeNegocio}{Parámetros}: \ioSeleccionar.
 			\end{itemize}
 			
 			\UCli Para el tipo ``Unicidad de parámetros'':
 			\begin{itemize}
 			 \item \cdtRef{ReglaDeNegocio:ValorDelParametroEnReglaDeNegocio}{Entidad}: \ioEscribir.
 			 \item \cdtRef{ReglaDeNegocio:ValorDelParametroEnReglaDeNegocio}{Atributo único}: \ioEscribir. 
 			\end{itemize}

 			\UCli Para el tipo ``Intervalo de fechas correcto'':
 			\begin{itemize}
 			 \item \cdtRef{ReglaDeNegocio:ValorDelParametroEnReglaDeNegocio}{Entidad que contiene el primer atributo de fecha}: \ioSeleccionar.
 			 \item \cdtRef{ReglaDeNegocio:ValorDelParametroEnReglaDeNegocio}{Primer atributo de fecha}: \ioSeleccionar.
 			 \item \cdtRef{ReglaDeNegocio:ValorDelParametroEnReglaDeNegocio}{Entidad que contiene el segundo atributo de fecha}: \ioSeleccionar.
 			 \item \cdtRef{ReglaDeNegocio:ValorDelParametroEnReglaDeNegocio}{Segundo atributo de fecha}: \ioSeleccionar.
 			\end{itemize}
		\end{UClist}
	}
	\UCitem{Salidas}{
	...
	\UCitem{Tipo}{
		Secundario, extiende del casos de uso \cdtIdRef{CU 8}{Gestionar regla de negocio}.
	}
\end{UseCase}
%-------------------------------------------------------%trayectoria Principal-----------------------------------------------
 \begin{UCtrayectoria}
    ...
    \UCpaso[\UCsist] Muestra la pantalla \cdtIdRef{IU 8.1}{Registrar reglas de negocio} en la cual se realizará el registro deIU 8.1 la regla de negocio. 
    ...
    \UCpaso[\UCactor] Solicita guardar la regla de negocio oprimiendo el botón \cdtButton{Aceptar} de la pantalla \cdtIdRef{IU 8.1}{Registrar reglas de negocio}. \refTray{K} \label{cu8:guardarInfo}
 ...
 \begin{UCtrayectoriaA}{B}{El tipo de regla de negocio es ``Intervalo de fechas correcto'' o ``Unicidad de parámetros''.}
	\UCpaso[\UCactor] El usuario ingresa la información de la regla de negocio en la pantalla \cdtIdRef{IU 8.1b}{Registrar reglas de negocio: Intervalo de fechas correcto}
	o \cdtIdRef{IU 8.1c}{Registrar reglas de negocio: Unicidad de parámetros}, según corresponda.
	\UCpaso[] Continúa con el paso \ref{cu8:guardarInfo} de la trayectoria principal.
 \end{UCtrayectoriaA}
