\begin{UseCase}{CU 5.1.1.2}{Modificar trayectoria}
	{
		...
		Este caso de uso permite al analista modificar la trayectoria principal o alternativa de un caso de uso.
		
	}
	\UCitem{Actor}{\cdtRef{actor:liderAnalisis}{Líder de análisis}, \cdtRef{actor:analista}{Analista}}
	\UCitem{Propósito}{
		Modificar una trayectoria principal o alternativa de un caso de uso.
	}
	\UCitem{Entradas}{
		\begin{UClist}
	...
	\UCitem{Precondiciones}{
		\begin{UClist}
			\UCli Que el caso de uso se encuentre en estado ``En edición''.
		\end{UClist}
	}
...
%-------------------------------------------------------%trayectoria Principal-----------------------------------------------
 \begin{UCtrayectoria}
	\UCpaso[\UCactor] Solicita modificar una trayectoria oprimiendo el botón \btnEditar de la la pantalla \cdtIdRef{IU 5.1.1}{Gestionar trayectorias}. 
	\UCpaso[\UCsist] Busca la información de la trayectoria.	
	\UCpaso[\UCsist] Muestra la información encontrada en la pantalla \cdtIdRef{IU 5.1.1.2}{Modificar trayectoria}.
