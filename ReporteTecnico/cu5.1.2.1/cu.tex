...
%-------------------------------------------------------%trayectoria Principal-----------------------------------------------
 ...
 \begin{UCtrayectoria}
	\UCpaso[\UCactor] Solicita registrar una precondición oprimiento el botón \btnAgregar de la sección ``Precondiciones'' de la pantalla \cdtIdRef{IU 5.1}{Registrar caso de uso} o de la pantalla \cdtIdRef{IU 5.2}{Modificar caso de uso}. 
