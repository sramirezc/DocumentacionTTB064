\begin{UseCase}{CU 11.3}{Eliminar entidad}
	...
	\UCitem{Errores}{
		\begin{UClist}
			\UCli \cdtIdRef{MSG14}{Eliminación no permitida}: Se muestra en una pantalla emergente cuando no se pueda eliminar la entidad debido a que está siendo referenciada en algún caso de uso.
