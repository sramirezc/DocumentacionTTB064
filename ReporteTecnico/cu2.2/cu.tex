...
%-------------------------------------------------------%trayectoria Principal-----------------------------------------------
 \begin{UCtrayectoria}
    \UCpaso[\UCactor] Solicita modificar una persona oprimiendo el botón \cdtButton{Registrar} de la pantalla \cdtIdRef{IU 2}{Gestionar personal}.
    ...
    \UCpaso[\UCactor] Modifica la información en la pantalla \cdtIdRef{IU 2.2}{Modificar persona}. \label{cu2.1:ingresaDatos}
