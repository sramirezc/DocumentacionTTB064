...
\begin{mensaje}{MSG1}{Operación exitosa}{Notificación}
    ...
    \item[Redacción:] OPERACIÓN exitosa.
    ...
    \end{Citemize}
    \item[Ejemplo:] {\em Registro} exitoso.
\end{mensaje}
...
\begin{mensaje}{MSG8}{Caso de uso terminado}{Confirmación}
    ...
    \item[Redacción:] ¿Está seguro de marcar como terminado este elemento? La información será enviada a corrección y no podrá realizar algún cambio.
\end{mensaje}
