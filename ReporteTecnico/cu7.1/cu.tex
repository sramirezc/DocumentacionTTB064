...
\end{UseCase}
 ...
 \begin{UCtrayectoria}
    ...
    \UCpaso[\UCsist] Verifica que exista información referente a la Cardindalidad. \refTray{G}
...
%----------------------------------------------------------%trayectoria D---------------------------------------------------- 
 ...
 %----------------------------------------------------------%trayectoria A---------------------------------------------------- 
 \begin{UCtrayectoriaA}[Fin del caso de uso]{G}{No existe información base para el sistema.}
