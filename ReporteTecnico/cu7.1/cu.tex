\begin{UseCase}{CU 7.1}{Registrar actor}
	...
	\UCitem{Mensajes}{	
		\begin{UClist}
			\UCli \cdtIdRef{MSG1}{Operación exitosa}: Se muestra en la pantalla \cdtIdRef{IU 7}{Gestionar casos de uso} para indicar que el registro fue exitoso.
		\end{UClist}
	}
	...
	\UCitem{Errores}{
		\begin{UClist}
			\UCli \cdtIdRef{MSG4}{Dato obligatorio}: Se muestra en la pantalla \cdtIdRef{IU 7.1}{Registrar caso de uso} cuando no se ha ingresado un dato marcado como obligatorio.
			\UCli \cdtIdRef{MSG7}{Dato incorrecto}: Se muestra en la pantalla \cdtIdRef{IU 7.1}{Registrar caso de uso} cuando el tipo de dato ingresado no cumple con el tipo de dato solicitado en el campo.
			\UCli \cdtIdRef{MSG6}{Longitud inválida}: Se muestra en la pantalla \cdtIdRef{IU 7.1}{Registrar caso de uso} cuando se ha excedido la longitud de alguno de los campos.
			\UCli \cdtIdRef{MSG7}{Registro repetido}: Se muestra en la pantalla \cdtIdRef{IU 7.1}{Registrar caso de uso} cuando se registre un caso de uso con un nombre o número que ya este registrado.
			\UCli \cdtIdRef{MSG17}{Dato no registrado}: Se muestra en la pantalla \cdtIdRef{IU 7.1}{Registrar caso de uso} cuando un elemento referenciado no existe en el sistema.
			\UCli \cdtIdRef{MSG23}{Caracteres inválidos}: Se muestra en la pantalla \cdtIdRef{IU 7.1}{Registrar caso de uso} cuando el nombre del caso de uso contiene un caracter no válido.
			\UCli \cdtIdRef{MSG27}{Token incorrecto}: Se muestra en la pantalla \cdtIdRef{IU 7.1}{Registrar caso de uso} cuando el token ingresado está mal formado.
		\end{UClist}
	}
	
	\UCitem{Tipo}{
		Secundario, extiende del caso de uso \cdtIdRef{CU 7}{Gestionar casos de uso}.
	}
...
\end{UseCase}
 ...
 \begin{UCtrayectoria}
    \UCpaso[\UCactor] Solicita registrar un caso de uso oprimiendo el botón \cdtButton{Registrar} de la pantalla \cdtIdRef{IU 7}{Gestionar casos de uso}.
    \UCpaso[\UCsist] Calcula la clave del caso de uso.
    \UCpaso[\UCsist] Muestra la pantalla \cdtIdRef{IU 7.1}{Registrar caso de uso} en la cual se realizará el registro del caso de uso. 
    \UCpaso[\UCactor] Ingresa la información general del caso de uso en la pantalla \cdtIdRef{IU 7.1}{Registrar caso de uso}. \label{cu7.1:ingresaDatos}
    \UCpaso[\UCactor] Ingresa los actores en la pantalla \cdtIdRef{IU 7.1}{Registrar caso de uso}. \refTray{A} \label{cu7.1:ingresaActores}
    \UCpaso[\UCactor] Ingresa las entradas en la pantalla \cdtIdRef{IU 7.1}{Registrar caso de uso}. \refTray{B} \refTray{C} \label{cu7.1:ingresaEntradas}
    \UCpaso[\UCactor] Ingresa las salidas en la pantalla \cdtIdRef{IU 7.1}{Registrar caso de uso}. \refTray{B} \refTray{C} \refTray{D} \label{cu7.1:ingresaSalidas}
    \UCpaso[\UCactor] Ingresa las reglas de negocio en la pantalla \cdtIdRef{IU 7.1}{Registrar caso de uso}. \refTray{E} \label{cu7.1:ingresaReglasNegocio}
    \UCpaso[\UCactor] Gestiona las precondiciones.\label{cu7.1:ingresaPrecond}
    \UCpaso[\UCactor] Gestiona las postcondiciones.\label{cu7.1:ingresaPostcond}
    \UCpaso[\UCactor] Solicita registrar el caso de uso oprimiendo el botón \cdtButton{Aceptar} de la pantalla \cdtIdRef{IU 7.1}{Registrar caso de uso}. \refTray{F}
    ...
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG1}{Operación exitosa} en la pantalla \cdtIdRef{IU 7}{Gestionar casos de uso} 
 ...
 \begin{UCtrayectoriaA}{A}{El actor desea ingresar un actor.}
    ...
    \UCpaso[] Continúa con el paso \ref{cu7.1:ingresaActores} de la trayectoria principal.
 \end{UCtrayectoriaA}
  %----------------------------------------------------------%trayectoria B---------------------------------------------------- 
 \begin{UCtrayectoriaA}{B}{El actor desea ingresar un término del glosario.}
    ...
    \UCpaso[] Continúa con el paso \ref{cu7.1:ingresaEntradas} o el paso \ref{cu7.1:ingresaSalidas} de la trayectoria principal.
 \end{UCtrayectoriaA}
...
%----------------------------------------------------------%trayectoria D---------------------------------------------------- 
 \begin{UCtrayectoriaA}{D}{El actor desea ingresar un mensaje.}
    ...
    \UCpaso[] Continúa con el paso \ref{cu7.1:ingresaSalidas} de la trayectoria principal.
 \end{UCtrayectoriaA}
 %----------------------------------------------------------%trayectoria E---------------------------------------------------- 
 \begin{UCtrayectoriaA}{E}{El actor desea ingresar una regla de negocio.}
    ...
    \UCpaso[] Continúa con el paso \ref{cu7.1:ingresaReglasNegocio} de la trayectoria principal.
 \end{UCtrayectoriaA}
 %----------------------------------------------------------%trayectoria F---------------------------------------------------- 
 \begin{UCtrayectoriaA}[Fin del caso de uso]{F}{El actor desea cancelar la operación.}
    \UCpaso[\UCactor] Solicita cancelar la operación oprimiendo el botón \cdtButton{Cancelar} de la pantalla \cdtIdRef{IU 7.1}{Registrar caso de uso}.
    \UCpaso[\UCsist] Elimina la información registrada en el sistema.
    \UCpaso[\UCsist] Muestra la pantalla \cdtIdRef{IU 7}{Gestionar casos de uso}.
 \end{UCtrayectoriaA}
  %----------------------------------------------------------%trayectoria G---------------------------------------------------- 
 \begin{UCtrayectoriaA}{G}{El actor no ingresó algún dato marcado como obligatorio.}
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG4}{Dato obligatorio} y señala el campo que presenta el error en la pantalla 
	    \cdtIdRef{CU 7.1}{Registrar caso de uso}, indicando al actor que el dato es obligatorio.
 ...
 \begin{UCtrayectoriaA}{H}{El actor ingresó un nombre de caso de uso repetido.}
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG7}{Registro repetido} y señala el campo que presenta la duplicidad en la pantalla 
	    \cdtIdRef{CU 7.1}{Registrar caso de uso}, indicando al actor que existe un caso de uso con el mismo nombre.
    \UCpaso[] Continúa con el paso \ref{cu7.1:ingresaDatos} de la trayectoria principal.
 \end{UCtrayectoriaA}
%----------------------------------------------------------%trayectoria I---------------------------------------------------- 
 ...
 \begin{UCtrayectoriaA}{J}{El actor ingresó un número de caso de uso repetido.}
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG7}{Registro repetido} y señala el campo que presenta la duplicidad en la pantalla 
	    \cdtIdRef{CU 7.1}{Registrar caso de uso}, indicando al actor que existe un caso de uso con el mismo número.
    \UCpaso[] Continúa con el paso \ref{cu7.1:ingresaDatos} de la trayectoria principal.
 \end{UCtrayectoriaA}
 %----------------------------------------------------------%trayectoria K---------------------------------------------------- 
 \begin{UCtrayectoriaA}{K}{El actor ingresó un tipo de dato incorrecto.}
    ...
    pantalla \cdtIdRef{IU 7.1}{Registrar caso de uso} para indicar que se ha ingresado un tipo de dato inválido.
    \UCpaso[] Continúa con el paso \ref{cu7.1:ingresaDatos} de la trayectoria principal.
 \end{UCtrayectoriaA}
 %----------------------------------------------------------%trayectoria L----------------------------------------------------  
 \begin{UCtrayectoriaA}{L}{El actor proporciona un dato que excede la longitud máxima.}
    ...
    longitud en la pantalla \cdtIdRef{IU 7.1}{Registrar caso de uso}, para indicar que el dato excede el tamaño máximo permitido.
    \UCpaso[] Continúa con el paso \ref{cu7.1:ingresaDatos} de la trayectoria principal.
 \end{UCtrayectoriaA}
 %----------------------------------------------------------%trayectoria M---------------------------------------------------- 
 ...
 \begin{UCtrayectoriaA}{N}{Alguno de los elementos referenciados no existe en el sistema.}
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG17}{Dato no registrado} mencionando el elemento que no está registrado en el sistema.
    \UCpaso[] Continúa con el paso \ref{cu7.1:ingresaDatos} de la trayectoria principal.
 \end{UCtrayectoriaA}
...
\UCExtensionPoint{El actor requiere registrar una precondición}
	{Paso \ref{cu7.1:ingresaPrecond} de la trayectoria principal}
	{\cdtIdRef{CU 7.1.2}{Registrar precondición}}
	
\UCExtensionPoint{El actor requiere registrar una postcondición}
	{Paso \ref{cu7.1:ingresaPostcond} de la trayectoria principal}
	{\cdtIdRef{CU 7.1.3}{Registrar postcondición}}