\begin{UseCase}{CU 11.5}{Registrar atributo}
	...
	\UCitem{Errores}{
		\begin{UClist}
			...
			\UCli \cdtIdRef{MSG23}{Caracteres inválidos}: Se muestra en la pantalla \cdtIdRef{IU 11.5}{Registrar atributo} cuando el nombre del atributo contiene un caracter no válido.
		\end{UClist}
	}
