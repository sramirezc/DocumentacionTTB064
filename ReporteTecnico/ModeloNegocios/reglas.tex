...
\begin{BusinessRule}{RN-S9}{Operaciones disponibles de casos de uso}
    ...
    \BRitem{Descripción}{
      ...
      \begin{longtable}{| p{.2\textwidth} | p{.3\textwidth} | p{.3\textwidth} |}%
		...
		En edición & Consultar, editar (solamente el analista que esté editando el caso de uso) & Consultar, editar (solamente el líder que esté editando el caso de uso) \\ \hline
		Terminado & Consultar, revisar, eliminar, editar (solamente el analista que terminó el caso de uso) & Consultar, revisar, eliminar, editar (solamente el líder que terminó el caso de uso)\\ \hline
		En revisión & Consultar, revisiar (solamente el analista que esté realizando la revisión) & Liberar, consultar, revisar (solamente el líder que esté realizando la revisión)\\ \hline
