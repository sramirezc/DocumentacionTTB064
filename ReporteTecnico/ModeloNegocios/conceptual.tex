...
\begin{figure}[htbp!]
	\begin{center}
		\fbox{\includegraphics[width=.8\textwidth]{ModeloNegocios/images/ModeloConceptualCasoUso}}
...
\begin{BusinessEntity}{Paso}{Paso}
    ...
    \Battr{FindelCasodeUso}{Fin del Caso de Uso}{\tdBooleano}{Bandera que especifica si el paso concluye el Caso de Uso.}{\requerido}
