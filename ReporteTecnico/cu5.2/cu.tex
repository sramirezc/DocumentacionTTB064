...
\end{UseCase}
 ...
 \begin{UCtrayectoria}
	...
	\UCpaso[\UCsist] Ingresa el comentario referente a la modificación realizada en la pantalla emergente \cdtIdRef{IU 5.2A}{Modificar caso de uso: Comentarios}. \label{cu5.2:ingresaComentario}
    \UCpaso[\UCsist] Verifica que el actor ingrese todos los campos obligatorios con base en la regla de negocio  \cdtIdRef{RN8}{Datos obligatorios}. \refTray{G}
