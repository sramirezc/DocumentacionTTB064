\begin{UseCase}{CU 5.1.1}{Gestionar trayectorias}
	...
	\UCitem{Salidas}{
		\begin{UClist}
			\UCli \cdtRef{CasodeUso}{Caso de uso}: \ioTabla{\cdtRef{Elemento:Clave}{Clave}, \cdtRef{Elemento:Numero}{Número}, \cdtRef{Elemento:Nombre}{Nombre}, y la \cdtRef{}{condición}}{de las trayectorias}.
		\end{UClist}
	}
...
\UCExtensionPoint{El actor requiere modificar una trayectoria}
	{Paso \ref{cu5.1.1:gestionaCU}}
	{\cdtIdRef{CU 5.1.1.2}{Registrar trayectoria}}
