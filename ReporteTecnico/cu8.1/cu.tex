	...
	\UCitem{Entradas}{
		\begin{UClist}
			\UCli \cdtRef{Elemento:Nombre}{Nombre}: \ioEscribir.
 			...
 			\begin{itemize}
 			 \item \cdtRef{ValorDelParametroEnReglaDeNegocio}{Parámetros}: \ioSeleccionar.
 			\end{itemize}
 			...
 			\UCli Para el tipo ``Otro'':
 			\begin{itemize}
 			 \item \cdtRef{ValorDelParametroEnReglaDeNegocio}{Redacción}: \ioEscribir.
 			\end{itemize}
		\end{UClist}
	}
	\UCitem{Salidas}{
...
%-------------------------------------------------------%trayectoria Principal-----------------------------------------------
 ...
 %----------------------------------------------------------%trayectoria B---------------------------------------------------- 
 \begin{UCtrayectoriaA}{B}{El tipo de regla de negocio es de tipo ``Unicidad de parámetros'', ``Intervalo de fechas correcto'' u ``Otro''.}
	\UCpaso[\UCactor] El usuario ingresa la información de la regla de negocio en la pantalla \cdtIdRef{IU 8.1b}{Registrar reglas de negocio: Unicidad de parámetros},
	\cdtIdRef{IU 8.1c}{Registrar reglas de negocio: Intervalo de fechas correcto} o \cdtIdRef{IU 8.1d}{Registrar reglas de negocio: Otro}, según corresponda.
	\UCpaso[] Continúa con el paso \ref{cu8:guardarInfo} de la trayectoria principal.
 \end{UCtrayectoriaA}
