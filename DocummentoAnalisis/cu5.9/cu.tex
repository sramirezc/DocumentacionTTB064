\newpage 
\begin{UseCase}{CU 5.9}{Liberar caso de uso}
	{
		Este caso de uso permite al líder de análisis revisar la información de un caso de uso y liberarlo.
	}
	
	\UCitem{Actor}{\cdtRef{actor:liderAnalisis}{Líder de análisis}}
	\UCitem{Propósito}{
		Revisar que la información del caso de uso sea correcta y marcar el caso de uso como Liberado.
	}
	\UCitem{Entradas}{
	...
	\UCitem{Precondiciones}{
		\begin{UClist}
			\UCli Que el caso de uso al que pertenece la trayectoria se encuentre en estado ``Por liberar''.
		\end{UClist}
	}
	
	\UCitem{Postcondiciones}{
		\begin{UClist}
			\UCli El caso de uso pasará a estado ``Liberado''.
		\end{UClist}
	}
	...
	\UCitem{Errores}{
		\begin{UClist}
			...
			\UCli \cdtIdRef{MSG13}{Ha ocurrido un error}: Se muestra en la pantalla donde se solicitó la operación cuando el caso de uso que se desea liberar no se encuentra en estado ``Por liberar''.
		\end{UClist}
	}
...
%-------------------------------------------------------%trayectoria Principal-----------------------------------------------
 \begin{UCtrayectoria}
	\UCpaso[\UCactor] Oprime el botón \btnLiberar del caso de uso que desea liberar en la pantalla \cdtIdRef{IU 5}{Gestionar casos de uso}.
    \UCpaso[\UCsist] Busca la información del caso de uso. 
    \UCpaso[\UCsist] Verifica que el estado del caso de uso sea ``Por liberar''. \refTray{A}
    \UCpaso[\UCsist] Muestra la información encontrada en la pantalla \cdtIdRef{IU 5.9}{Liberar caso de uso}.
    \UCpaso[\UCactor] Selecciona la opción ``Sí'' para cada una de las secciones. \refTray{B} \label{cu5.9:selecciona}
	\UCpaso[\UCactor] Solicita liberar el caso de uso oprimiendo el botón \cdtButton{Aceptar}. \refTray{F} \label{cu5.9:oprime}
 ...
 %----------------------------------------------------------%trayectoria A---------------------------------------------------- 
 \begin{UCtrayectoriaA}[Fin del caso de uso]{A}{El caso de uso que se desea revisar se encuentra en un estado diferente a ``Por liberar''}
