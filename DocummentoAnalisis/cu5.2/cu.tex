...
\begin{UseCase}{CU 5.2}{Modificar caso de uso}
	...
	\UCitem{Salidas}{	
		\begin{UClist}
			...
			\UCli \cdtRef{Revision:Observaciones}{Observaciones} realizadas a la sección ``Resumen'' del caso de uso: \ioObtener.	
	...
	\UCitem{Postcondiciones}{ 
		\begin{UClist}
			...
			\UCli El caso de uso pasará a estado ``Edición''.
	 	\end{UClist}
	}
	\UCitem{Errores}{
		\begin{UClist}
			...
			\UCli \cdtIdRef{MSG7}{Registro repetido}: Se muestra en la pantalla \cdtIdRef{IU 5.2}{Modificar caso de uso} cuando se registre un caso de uso con un nombre o número que ya se encuentre registrado.
...
\end{UseCase}
 ...
 \begin{UCtrayectoria}
	...
	\UCpaso[\UCsist] Verifica que el estado del caso de uso sea ``Edición'' o ``Pendiente de corrección''. \refTray{Q}
    ...
    \UCpaso[\UCsist] Muestra la pantalla \cdtIdRef{IU 5.2}{Modificar caso de uso} en la cual se realizará la modificación del caso de uso con las observaciones encontradas. 
...
%----------------------------------------------------------%trayectoria I---------------------------------------------------- 
 ...
 %----------------------------------------------------------%trayectoria Q---------------------------------------------------- 
  \begin{UCtrayectoriaA}[Fin del caso de uso]{Q}{El caso de uso no se encuentra en estado ``Edición'' o ``Pendiente de corrección''.}
...
\UCExtensionPoint{El actor requiere eliminar una precondición}
	{Paso \ref{cu5.2:ingresaPrecond} de la trayectoria principal}
	{\cdtIdRef{CU 5.1.3}{Eliminar precondición}}
	
\UCExtensionPoint{El actor requiere registrar una postcondición}
	{Paso \ref{cu5.2:ingresaPostcond} de la trayectoria principal}
	{\cdtIdRef{CU 5.1.4}{Registrar postcondición}}

\UCExtensionPoint{El actor requiere eliminar una postcondición}
	{Paso \ref{cu5.2:ingresaPostcond} de la trayectoria principal}
	{\cdtIdRef{CU 5.1.5}{Eliminar postcondición}}