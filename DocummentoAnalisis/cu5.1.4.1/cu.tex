...
%-------------------------------------------------------%trayectoria Principal-----------------------------------------------
 ...
 \begin{UCtrayectoria}
	\UCpaso[\UCactor] Solicita registrar un punto de extensión oprimiento el botón \cdtButton{Registrar} de la pantalla \cdtIdRef{IU 5.1.4}{Gestionar puntos de extensión}. 
	...
	\UCpaso[\UCsist] Verifica que los tokens utilizados esten bien formados. \refTray{F}
