...
\begin{description}
	...
	\item[\cdtIdRef{MSG7}{Registro repetido}:] Se muestra en la pantalla \cdtIdRef{IU 11.1.1}{Registrar atributo} cuando se registre un atributo con un nombre que ya se encuentre registrado.
\end{description}
