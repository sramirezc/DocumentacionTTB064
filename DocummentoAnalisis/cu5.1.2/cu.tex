...
%-------------------------------------------------------%trayectoria Principal-----------------------------------------------
 ...
 \begin{UCtrayectoria}
	...
	\UCpaso[\UCactor] Solicita registrar la precondición oprimiendo el botón \cdtButton{Aceptar} de la pantalla \cdtIdRef{CU 5.1.2}{Registrar precondición}. \refTray{L} 
...
%----------------------------------------------------------%trayectoria D---------------------------------------------------- 
 ...
 \begin{UCtrayectoriaA}[Fin del caso de uso]{L}{El actor desea cancelar la operación.}
    \UCpaso[\UCactor] Solicita cancelar la operación oprimiendo el botón \cdtButton{Cancelar} de la pantalla \cdtIdRef{CU 5.1.2}{Registrar precondición}.
