...
\begin{UseCase}{CU 5.1}{Registrar caso de uso}
	...
	\UCitem{Errores}{
		\begin{UClist}
			...
			\UCli \cdtIdRef{MSG7}{Registro repetido}: Se muestra en la pantalla \cdtIdRef{IU 5.1}{Registrar caso de uso} cuando se registre un caso de uso con un nombre o número que ya se encuentre registrado.
