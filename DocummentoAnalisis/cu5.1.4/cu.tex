...
%-------------------------------------------------------%trayectoria Principal-----------------------------------------------
 ...
 \begin{UCtrayectoria}
	...
	\UCpaso[\UCactor] Solicita registrar la postcondición oprimiendo el botón \cdtButton{Aceptar} de la pantalla \cdtIdRef{IU 5.1.4}{Registrar postcondición}. \refTray{L} 
...
%----------------------------------------------------------%trayectoria D---------------------------------------------------- 
 ...
 \begin{UCtrayectoriaA}[Fin del caso de uso]{L}{El actor desea cancelar la operación.}
    \UCpaso[\UCactor] Solicita cancelar la operación oprimiendo el botón \cdtButton{Cancelar} de la pantalla \cdtIdRef{IU 5.1.4}{Registrar postcondición }.
 ...
 \begin{UCtrayectoriaA}{N}{El actor proporciona un dato que excede la longitud máxima.}
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG6}{Longitud inválida} en una pantalla emergente.
    \UCpaso[] Continúa con el paso \ref{cu5.1.4:ingresaDatos} de la trayectoria principal.
 \end{UCtrayectoriaA}
