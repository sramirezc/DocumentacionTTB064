\begin{UseCase}{CU 3.2}{Modificar módulo}
	...
	\UCitem{Errores}{
		\begin{UClist}
			...
			\UCli \cdtIdRef{MSG7}{Registro repetido}: Se muestra en la pantalla \cdtIdRef{IU 3.1}{Registrar módulo} cuando se ingrese un nombre o clave repetido en el proyecto.
		\end{UClist}
	}
...
%-------------------------------------------------------%trayectoria Principal-----------------------------------------------
 \begin{UCtrayectoria}
    \UCpaso[\UCactor] Solicita modificar un módulo oprimiendo el botón \btnEditar de la pantalla \cdtIdRef{IU 3}{Gestionar módulos}.
