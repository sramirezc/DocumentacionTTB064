...
\begin{BusinessEntity}{Proyecto}{Proyecto}
      ...
      \Battr{FechaDeInicio}{Fecha de Inicio}{\tdFecha}{Fecha en que se arranca el proyecto}{\opcional}
      \Battr{FechaDeTermino}{Fecha de Término}{\tdFecha}{Fecha en que consluye el proyecto}{\opcional}
      ...
      \Battr{Lider}{Líder}{\tdParrafo}{Párrafo que contiene el nombre y apellidos del líder del proyecto}{\requerido}
...
\begin{BusinessEntity}{Colaborador}{Colaborador}
      ...
      \Battr{SegundoApellido}{Segundo Apellido}{\tdFrase}{Nombre de familia con que se distinguen las personas}{\opcional}
      ...
      \Battr{Telefono}{Teléfono}{\tdTelefono}{Es la clave LADA más una secuencia de dígitos}{\requerido}
\end{BusinessEntity}
...
\begin{BusinessFact}{Actualizacion:EstadoDelElemento}{Estado del Elemento}
	\BRitem{Descripción}{Una actualización debe indicar de qué a qué \cdtRef{gls:EstadoDelElemento}{estado} ha cambiado el elemento.}
	\BRitem{Tipo}{\relAsociacion}
