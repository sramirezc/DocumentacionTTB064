...
\begin{BusinessEntity}{Pantalla}{Pantalla}
	  ...
	  \Battr{Imagen}{Imagen}{Es un archivo en formato PNG o JPG}{Imagen que ilustrará la interfaz gráfica del sistema}{\requerido}
      \Battr{Patron}{Patrón}{\tdFrase}{Texto que contiene la pantalla para su identificación}{\requerido}
...
\begin{BusinessEntity}{Accion}{Acción}
	  ...
	  \Battr{URL}{URL}{\tdPalabra}{URL que determinará el destino de la Acción}{\requerido}
	  \Battr{Metodo}{Método}{\tdPalabra}{Especifica cómo se realizará la petición HTTP}{\requerido}
...
\begin{BusinessEntity}{RegladeNegocio}{Regla de Negocio}
      ...
      \Battr{Query}{Query}{\tdFrase}{Es un query para verificar la existencia de catálogos o para verificar la unicidad de los registros}{\requerido}
\end{BusinessEntity}
...
\begin{BusinessEntity}{Salida}{Salida}
    \Battr{HTMLValue}{HTML Value}{\tdFrase}{Valor HTML que tomará un determinado parámetro al realizar la ejecución de la prueba}{\requerido}
    \Battr{HTMLName}{HTML Name}{\tdPalabra}{Nombre del parámetro HTML que tomará un determinado valor al realizar la ejecución de la prueba}{\requerido}
...
\begin{BusinessEntity}{Revision}{Revisión}
    \Battr{Observaciones}{Observaciones}{\tdParrafo}{Texto que describe los errores y/o cambios que deben realizarse al caso de uso}{\requerido}
\end{BusinessEntity}
...
\begin{BusinessEntity}{ValordelParametroenMensaje}{Valor del Parámetro en Mensaje}
    \Battr{Valor}{Valor}{\tdParrafo}{Valor del parámetro que tendrá un mensaje parametrizado al realizar la ejecución de una prueba}{\requerido}
\end{BusinessEntity}

\subsubsection{Relaciones}

\begin{BusinessFact}{ValordelParametroenMensaje:Mensaje}{Mensaje}
	\BRitem{Descripción}{El valor del parámetro dependerá del mensaje en cuestión.}
	\BRitem{Tipo}{\relAgregacion}
    \BRitem{Cardinalidad}{Muchos a uno}
\end{BusinessFact}

\begin{BusinessFact}{ValordelParametroenMensaje:ParametrodelMensaje}{Parámetro del Mensaje}
	\BRitem{Descripción}{El valor del parámetro corresponde a un tipo de parámetro.}
	\BRitem{Tipo}{\relAsociacion}
    \BRitem{Cardinalidad}{Muchos a uno}
\end{BusinessFact}
...
\begin{BusinessEntity}{ValordelParametroenRegladeNegocio}{Valor del Parámetro en Regla de Negocio}
    \Battr{Valor}{Valor}{\tdParrafo}{Valor del parámetro que tendrá una regla de negocio al realizar la ejecución de una prueba}{\requerido}
\end{BusinessEntity}

\subsubsection{Relaciones}

\begin{BusinessFact}{ValordelParametroenRegladeNegocio:RegladeNegocio}{Regla de Negocio}
	\BRitem{Descripción}{El valor del parámetro dependerá de la regla de negocio en cuestión.}
	\BRitem{Tipo}{\relAgregacion}
    \BRitem{Cardinalidad}{Muchos a uno}
\end{BusinessFact}

\begin{BusinessFact}{ValordelParametroenRegladeNegocio:ParametrodelaRegladeNegocio}{Parámetro de la Regla de Negocio}
	\BRitem{Descripción}{El valor del parámetro corresponde a un tipo de parámetro de Regla de Negocio.}
	\BRitem{Tipo}{\relAsociacion}
    \BRitem{Cardinalidad}{Muchos a uno}
\end{BusinessFact}
...
\begin{BusinessEntity}{Configuraciondepruebas}{Configuración de pruebas}
    \Battr{URLBasededatos}{URL Base de datos}{\tdPalabra}{URL de la base de datos a la que se harán peticiones al realizar la ejecución de una prueba}{\requerido}
    \Battr{DriverBasededatos}{Driver Base de datos}{\tdPalabra}{Driver de la base de datos a la que se harán peticiones al realizar la ejecución de una prueba}{\requerido}
	 \Battr{UsuarioBasededatos}{Usuario Base de datos}{\tdPalabra}{Usuario del servidor de la base de datos a la que se harán peticiones al realizar la ejecución de una prueba}{\requerido}
	 \Battr{ContraseniaBasededatos}{Contraseña Base de datos}{\tdPalabra}{Contraseña del servidor de la base de datos a la que se harán peticiones al realizar la ejecución de una prueba}{\requerido}
 \Battr{ServidoroIP}{Servidor o IP}{\tdPalabra}{Nombre del servidor o IP en la cual se aloja el sistema a probar}{\requerido}
 \Battr{Puerto}{Puerto}{\tdPalabra}{Puerto por el cual se accede al sistema a probar}{\requerido}
...
\begin{BusinessFact}{Configuraciondepruebas:Casodeuso}{Caso de uso}
	\BRitem{Descripción}{Cada caso de uso posee una configuración específica de pruebas.}
	\BRitem{Tipo}{\relAsociacion}
    \BRitem{Cardinalidad}{Uno a uno}
\end{BusinessFact}
