...
\begin{BusinessEntity}{Salida}{Salida}
    \Battr{HTMLValue}{HTML Value}{\tdFrase}{Valor HTML que tomará un determinado parámetro a realizar la ejecución de la prueba}{\requerido}
    \Battr{HTMLValue}{HTML Name}{\tdPalabra}{Nombre del parámetro HTML que tomará un determinado valor a realizar la ejecución de la prueba}{\requerido}
...
\begin{BusinessEntity}{Revision}{Revisión}
    \Battr{Observaciones}{Observaciones}{\tdParrafo}{Texto que describe los errores y/o cambios que deben realizarse al caso de uso identificados durante su revisión}{\requerido}
\end{BusinessEntity}
...
\begin{BusinessEntity}{Configuraciondepruebas}{Configuracion de pruebas}
    ...
    \Battr{DriverBasededatos}{Driver Base de datos}{\tdPalabra}{Nombre de la base de datos a la que se harán peticiones al realizar la ejecución de una prueba}{\requerido}
