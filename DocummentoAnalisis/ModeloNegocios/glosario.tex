...
%	\BRterm{gls:nombre}{nombre.} Descripción.
	...
	\BRterm{gls:Cardinalidad}{Cardinalidad.} Es el número de actores que participarán o serán requeridos en el sistema. Es un \cdtRef{gls:tipoDato}{tipo de dato} para el sistema y puede tomar alguno de los siguientes valores:
	Uno, Muchos u Otro.

	\BRterm{gls:elemento}{Elemento.} Se utiliza para referirse a los casos de uso, pantallas, reglas de negocio, entidades, términos del glosario, mensajes y actores.
	...
	\BRterm{gls:imagen}{Imagen.} Es una imagen digital de tamaño pequeño (no más de un Megabyte) en formato jpeg.
