...
\begin{BusinessRule}{RN1}{Unicidad de números}
    ...
    \BRitem{Autor}{Natalia Giselle Hernández Sánchez}
    \BRitem{Estatus}{Terminada}
    \BRitem{Descripción}{El número de los elementos del mismo tipo no puede repetirse.}	
\end{BusinessRule}
...
\begin{BusinessRule}{RN9}{Operaciones disponibles de casos de uso}
    ...
    \BRitem{Descripción}{
      ...
      \begin{longtable}{| p{.2\textwidth} | p{.3\textwidth} | p{.3\textwidth} |}%
		...
		Preconfigurado & Consultar y configurar prueba & Consultar, solicitar correcciones, configurar prueba \\ \hline
...
\begin{BusinessRule}{RN12}{Identificador de elemento}
    ...
    \BRitem{Autor}{Natalia Giselle Hernández Sánchez}
    \BRitem{Estatus}{Terminada}
    \BRitem{Descripción}{El identificador de cada elemento (excepto casos de uso y pantallas) se compone de un nombre, número y una clave. Donde el nombre es el que le asigna el usuario, el número 
    es secuencial y la clave define el tipo de elemento: ``ENT'' para las entidades, ``ACT'' para los actores, ``MSG'' para los mensajes, ``RN'' para las reglas de negocio y ``GLS'' para los términos del glosario.\\
    
    El identificador de los casos de uso y de las pantallas se compone de un nombre, número, clave y clave del módulo. Donde el nombre es el que le asigna el usuario, el número 
    es secuencial, la clave define el tipo de elemento:  ``CU'' para los casos de uso y ``IU'' para las pantallas, y finalmente la clave del módulo al que pertenece el caso de uso o pantalla.}	
    % Se sacrifica la usabilidad por el tiempo reducido de desarrollo
...
\begin{BusinessRule}{RN21}{Estados para iniciar un proyecto}
    ...
    \BRitem{Autor}{Natalia Giselle Hernández Sánchez}
    \BRitem{Estatus}{Terminada}
    \BRitem{Descripción}{Se podrán registrar proyectos con estado ``Negociación'' o ``Iniciado''.}
\end{BusinessRule}
