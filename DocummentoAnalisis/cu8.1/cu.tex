...
\begin{UseCase}{CU 8.1}{Registrar regla de negocio}
	...
	\UCitem{Errores}{
		\begin{UClist}
			...
			\UCli \cdtIdRef{MSG7}{Registro repetido}: Se muestra en la pantalla \cdtIdRef{IU 8.1}{Registrar regla de negocio} cuando se registre una regla de negocio con un nombre o número que ya se encuentre registrado.
