...
%-------------------------------------------------------%trayectoria Principal-----------------------------------------------
 ...
 \begin{UCtrayectoria}
	...
	\UCpaso[\UCsist] Modifica el paso en la tabla de la pantalla \cdtIdRef{IU 5.1.1.1}{Registrar trayectoria} o de la pantalla \cdtIdRef{IU 5.1.1.2}{Modificar trayectoria}.
\end{UCtrayectoria}
