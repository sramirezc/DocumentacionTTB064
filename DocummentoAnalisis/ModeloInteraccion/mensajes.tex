...
%============================== MSG36 =================================
\begin{mensaje}{MSG36}{Elemento no registrado}{Error}
    \item[Objetivo:] Informar al actor que no es posible completar la operación debido a que se está utilizando un elemento que no se encuentra registrado en el sistema.
    \item[Redacción:] Datos incorrectos, DETERMINADO ELEMENTO no se encuentra registrado en el sistema.
    \item[Parámetros:] El mensaje se muestra con base en los siguientes parámetros:
    \begin{Citemize}
	\item DETERMINADO ELEMENTO: Artículo determinado más el nombre del elemento que se desea referenciar.
    \end{Citemize}
    \item[Ejemplo:] Datos incorrectos, {\em el actor tester} no se encuentra registrado en el sistema.
\end{mensaje}
