...
\begin{UseCase}{CU 9}{Gestionar mensajes}
	...
	\UCitem{Mensajes}{
		\begin{UClist}
			\UCli \cdtIdRef{MSG2}{No existe información}: Se muestra en la pantalla \cdtIdRef{IU 9}{Gestionar mensajes} cuando no existen mensajes registrados.
		\end{UClist}
	}
	...
	\UCitem{Postcondiciones}{
		\begin{UClist}
			...
			\UCli Se podrá solicitar la consulta de un mensaje por medio del caso de uso \cdtIdRef{CU 9.4}{Consultar mensaje}.
		\end{UClist}
	}
...
%-------------------------------------------------------%trayectoria Principal-----------------------------------------------
 \begin{UCtrayectoria}
    ...
    \UCpaso[\UCactor] Gestiona los mensajes a través de los botones: \cdtButton{Registrar}, \btnConsulta, \btnEditar y \btnEliminar. \label{cu9:gestiona}
 \end{UCtrayectoria}
...
\UCExtensionPoint{El actor requiere consultar un mensaje}
	{Paso \ref{cu9:gestiona}}
