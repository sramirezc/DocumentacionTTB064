...
\begin{UseCase}{CU 5.1.1.2}{Modificar trayectoria}
	...
	\UCitem{Errores}{
		\begin{UClist}
			...
			\UCli \cdtIdRef{MSG13}{Ha ocurrido un error}: Se muestra en la pantalla \cdtIdRef{IU 5.1.1}{Gestionar trayectorias} cuando no existan verbos registrados en el sistema o cuando el estado del caso de uso al que pertenece la trayectoria sea inválido.
