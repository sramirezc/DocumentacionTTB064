...
\begin{itemize}
	...
	\item \cdtButton{Cancelar}: Permite al actor cancelar la revisión, dirige a la pantalla \cdtRef{IU 5}{Gestionar casos de uso}
\end{itemize}
...
\begin{description}
	...
	\item \cdtIdRef{MSG4}{Dato obligatorio}: Se muestra en la pantalla \cdtIdRef{IU 5.5}{Revisar caso de uso} cuando no se ha ingresado un dato marcado como obligatorio.
	
	\item \cdtIdRef{MSG6}{Longitud inválida}: Se muestra en la pantalla \cdtIdRef{IU 5.5}{Revisar caso de uso} cuando se ha excedido la longitud de alguno de los campos.
