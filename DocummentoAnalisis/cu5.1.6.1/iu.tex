...
\subsubsection{Diseño}
    ...
    \IUfig[.9]{cu5.1.6.1/images/iu.png}{IU 5.1.6.1}{Registrar punto de extensión}
...
\begin{description}
	...
	\item[ \cdtIdRef{MSG4}{Dato obligatorio}:] Se muestra en la pantalla \cdtIdRef{IU 5.1.6.1}{Registrar punto de extensión} cuando no se ha ingresado un dato marcado como obligatorio.
	\item[ \cdtIdRef{MSG6}{Longitud inválida}:] Se muestra en la pantalla \cdtIdRef{IU 5.1.6.1}{Registrar punto de extensión} cuando se ha excedido la longitud de alguno de los campos.
	\item[\cdtIdRef{MSG7}{Registro repetido}:] Se muestra en la pantalla \cdtIdRef{IU 5.1.6.1}{Registrar punto de extensión} cuando se ha ingresado un punto de extensión que ya existe.
	\item[\cdtIdRef{MSG15}{Dato no registrado}:] Se muestra en la pantalla \cdtIdRef{IU 5.1.6.1}{Registrar punto de extensión} cuando un elemento referenciado no existe en el sistema.
	\item[\cdtIdRef{MSG27}{Token incorrecto}:] Se muestra en la pantalla \cdtIdRef{IU 5.1.6.1}{Registrar punto de extensión} cuando el token ingresado está mal formado.
\end{description}
