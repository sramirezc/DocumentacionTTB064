...
\begin{description}
	...
	\item[\cdtIdRef{MSG7}{Registro repetido}:] Se muestra en la pantalla \cdtIdRef{CU 5.1.6.1}{Registrar punto de extensión} cuando se ha ingresado un punto de extensión que ya existe.
	\item[\cdtIdRef{MSG15}{Dato no registrado}:] Se muestra en la pantalla \cdtIdRef{CU 5.1.6.1}{Registrar punto de extensión} cuando un elemento referenciado no existe en el sistema.
	\item[\cdtIdRef{MSG27}{Token incorrecto}:] Se muestra en la pantalla \cdtIdRef{CU 5.1.6.1}{Registrar punto de extensión} cuando el token ingresado está mal formado.
\end{description}
