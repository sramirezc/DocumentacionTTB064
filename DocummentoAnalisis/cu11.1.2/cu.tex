...
\begin{UseCase}{CU 11.1.2}{Modificar atributo}
	...
	\UCitem{Errores}{
		\begin{UClist}
			...
			\UCli \cdtIdRef{MSG7}{Registro repetido}: Se muestra en la pantalla \cdtIdRef{IU 11.1.2}{Modificar atributo} cuando se registre un atributo con un nombre que ya se encuentre registrado.
